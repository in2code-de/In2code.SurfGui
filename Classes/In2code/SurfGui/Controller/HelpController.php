...
class HelpController extends BasicController {
	...
	public function __construct() {
		...
		require_once(FLOW_PATH_ROOT . 'Packages/Application/In2code.SurfGui/Resources/Private/Php/php-restructuredtext-0.1/rst.php');
	}

	protected function initializeAction() {
		parent::initializeAction();
		$this->languageFolder = $this->i18nService->getConfiguration()->getCurrentLocale()->getLanguage();
	}
